...
X,y,Xtest,ytest = pickle.load(open('D:\Chirag\Savefiles\Downloads\ML\A2\sample.pickle','rb'))            
...
X,y,Xtest,ytest = pickle.load(open('D:\Chirag\Savefiles\Downloads\ML\A2\diabetes.pickle','rb'))   
# add intercept
